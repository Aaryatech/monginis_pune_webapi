...
public interface GetCreditNoteHeaderRepo extends JpaRepository<GetCreditNoteHeaders, Integer> {
	...
	@Query(value = " SELECT ch.ex_varchar2, ch.crn_id,ch.ex_int1,ch.grn_gvn_sr_no_list,ch.ex_varchar1,ch.crn_date,ch.fr_id,ch.crn_taxable_amt,ch.crn_total_tax,ch.crn_grand_total,ch.round_off,ch.is_tally_sync, "
